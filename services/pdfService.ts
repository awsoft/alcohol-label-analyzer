...
export const generatePDFReport = async (
  ...
  doc.setFont('helvetica', 'normal');
  yPosition = addWrappedText('The information from this app is in no way affiliated with official TTB business. This analysis is for informational purposes only and should not be considered as official TTB guidance or approval. Always consult with TTB directly and qualified legal experts for official compliance matters.', margin, yPosition + 8, pageWidth - 40, 7, false);
